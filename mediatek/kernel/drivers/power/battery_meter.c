...
bool bat_spm_timeout_sync_ui_soc = false; //<2014/06/12-tedwu, Customize time and UI_SOC for SYNC_TO_REAL.//>
U32 _g_bat_sleep_total_time = 0;
kal_int32 g_booting_vbat=0;

//<2014/06/06-tedwu, For battery temperature protection.
INT32 g_old_temperature =0;
INT32 g_new_temperature =0;
//>2014/06/06-tedwu
...
//<2014/3/5--jtao.lee, For temperture test.
...
//<2014/05/04-tedwu, Customize Battery/Charging parameters.
    ...
    else if(Res<=Batt_Temperature_Table[33].TemperatureR)
    {
        TBatt_Value = 125;
    }
#else
...
//<2014/05/04-tedwu, Customize Battery/Charging parameters.
        ...
        if (BATTERY_PACK_BL_44JH == battery_pack_id) {
            low_Q_max = Q_MAX_NEG_10_BL_44JH;
        } else { //BATTERY_PACK_BL_44JN
            low_Q_max = Q_MAX_NEG_10_BL_44JN;
        }
#else
...
#if defined(ARIMA_LO1_HW)
        if (BATTERY_PACK_BL_44JH == battery_pack_id) {
            high_Q_max = Q_MAX_POS_0_BL_44JH;
        } else { //BATTERY_PACK_BL_44JN
            high_Q_max = Q_MAX_POS_0_BL_44JN;
        }
#else
...
#if defined(ARIMA_LO1_HW)
        if (BATTERY_PACK_BL_44JH == battery_pack_id)
            low_Q_max = Q_MAX_POS_0_BL_44JH;
        else //BATTERY_PACK_BL_44JN
            low_Q_max = Q_MAX_POS_0_BL_44JN;
#else
...
#if defined(ARIMA_LO1_HW)
        if (BATTERY_PACK_BL_44JH == battery_pack_id)
            high_Q_max = Q_MAX_POS_25_BL_44JH;
        else //BATTERY_PACK_BL_44JN
            high_Q_max = Q_MAX_POS_25_BL_44JN;
#else
...
#if defined(ARIMA_LO1_HW)
        if (BATTERY_PACK_BL_44JH == battery_pack_id)
            low_Q_max = Q_MAX_POS_25_BL_44JH;
        else //BATTERY_PACK_BL_44JN
            low_Q_max = Q_MAX_POS_25_BL_44JN;
#else
...
#if defined(ARIMA_LO1_HW)
        if (BATTERY_PACK_BL_44JH == battery_pack_id)
            high_Q_max = Q_MAX_POS_50_BL_44JH;
        else //BATTERY_PACK_BL_44JN
            high_Q_max = Q_MAX_POS_50_BL_44JN;
#else
...
#if defined(ARIMA_LO1_HW)
        if (BATTERY_PACK_BL_44JH == battery_pack_id)
            low_Q_max = Q_MAX_NEG_10_H_CURRENT_BL_44JH;
        else //BATTERY_PACK_BL_44JN
            low_Q_max = Q_MAX_NEG_10_H_CURRENT_BL_44JN;
#else
...
#if defined(ARIMA_LO1_HW)
        if (BATTERY_PACK_BL_44JH == battery_pack_id)
            high_Q_max = Q_MAX_POS_0_H_CURRENT_BL_44JH;
        else //BATTERY_PACK_BL_44JN
            high_Q_max = Q_MAX_POS_0_H_CURRENT_BL_44JN;
#else
...
#if defined(ARIMA_LO1_HW)
        if (BATTERY_PACK_BL_44JH == battery_pack_id)
            low_Q_max = Q_MAX_POS_0_H_CURRENT_BL_44JH;
        else //BATTERY_PACK_BL_44JN
            low_Q_max = Q_MAX_POS_0_H_CURRENT_BL_44JN;
#else
...
#if defined(ARIMA_LO1_HW)
        if (BATTERY_PACK_BL_44JH == battery_pack_id)
            high_Q_max = Q_MAX_POS_25_H_CURRENT_BL_44JH;
        else //BATTERY_PACK_BL_44JN
            high_Q_max = Q_MAX_POS_25_H_CURRENT_BL_44JN;
#else
...
#if defined(ARIMA_LO1_HW)
        if (BATTERY_PACK_BL_44JH == battery_pack_id)
            low_Q_max = Q_MAX_POS_25_H_CURRENT_BL_44JH;
        else //BATTERY_PACK_BL_44JN
            low_Q_max = Q_MAX_POS_25_H_CURRENT_BL_44JN;
#else
...
#if defined(ARIMA_LO1_HW)
        if (BATTERY_PACK_BL_44JH == battery_pack_id)
            high_Q_max = Q_MAX_POS_50_H_CURRENT_BL_44JH;
        else //BATTERY_PACK_BL_44JN
            high_Q_max = Q_MAX_POS_50_H_CURRENT_BL_44JN;
#else
...
int BattVoltToTemp(int dwVolt)
{
    ...
    //<2014/05/26-tedwu, Not charging for BT test in Lab.
    //<2014/3/5--jtao.lee, For temperture test.  
    if(temperature_flag)
        return 15; //56;
    else
...
#if defined(ARIMA_LO1_HW)
    if (BATTERY_PACK_BL_44JH == battery_pack_id) {
        return sizeof(battery_profile_t2_BL_44JH) / sizeof(BATTERY_PROFILE_STRUC);
    } else { //BATTERY_PACK_BL_44JN
        return sizeof(battery_profile_t2_BL_44JN) / sizeof(BATTERY_PROFILE_STRUC);
    }
#else
...
#if defined(ARIMA_LO1_HW)
    if (BATTERY_PACK_BL_44JH == battery_pack_id) {
        return sizeof(r_profile_t2_BL_44JH) / sizeof(R_PROFILE_STRUC);
    } else { //BATTERY_PACK_BL_44JN
        return sizeof(r_profile_t2_BL_44JN) / sizeof(R_PROFILE_STRUC);
    }
#else
...
BATTERY_PROFILE_STRUC_P fgauge_get_profile(kal_uint32 temperature)
{
    ...
    if (BATTERY_PACK_BL_44JH == battery_pack_id) {
        ...
        {
            case TEMPERATURE_T0:
                return &battery_profile_t0_BL_44JH[0];
                break;    
            case TEMPERATURE_T1:
                return &battery_profile_t1_BL_44JH[0];
                break;
            case TEMPERATURE_T2:
                return &battery_profile_t2_BL_44JH[0];
                break;
            case TEMPERATURE_T3:
                return &battery_profile_t3_BL_44JH[0];
                break;
            case TEMPERATURE_T:
                return &battery_profile_temperature_BL_44JH[0];
                break;
            default:
                return NULL;
                break;
        ...
        {
            case TEMPERATURE_T0:
                return &battery_profile_t0_BL_44JN[0];
                break;    
            case TEMPERATURE_T1:
                return &battery_profile_t1_BL_44JN[0];
                break;
            case TEMPERATURE_T2:
                return &battery_profile_t2_BL_44JN[0];
                break;
            case TEMPERATURE_T3:
                return &battery_profile_t3_BL_44JN[0];
                break;
            case TEMPERATURE_T:
                return &battery_profile_temperature_BL_44JN[0];
                break;
            default:
                return NULL;
                break;
...
R_PROFILE_STRUC_P fgauge_get_profile_r_table(kal_uint32 temperature)
{
    ...
    if (BATTERY_PACK_BL_44JH == battery_pack_id) {
        ...
        {
            case TEMPERATURE_T0:
                return &r_profile_t0_BL_44JH[0];
                break;
            case TEMPERATURE_T1:
                return &r_profile_t1_BL_44JH[0];
                break;
            case TEMPERATURE_T2:
                return &r_profile_t2_BL_44JH[0];
                break;
            case TEMPERATURE_T3:
                return &r_profile_t3_BL_44JH[0];
                break;
            case TEMPERATURE_T:
                return &r_profile_temperature_BL_44JH[0];
                break;
            default:
                return NULL;
                break;
        ...
        {
            case TEMPERATURE_T0:
                return &r_profile_t0_BL_44JN[0];
                break;
            case TEMPERATURE_T1:
                return &r_profile_t1_BL_44JN[0];
                break;
            case TEMPERATURE_T2:
                return &r_profile_t2_BL_44JN[0];
                break;
            case TEMPERATURE_T3:
                return &r_profile_t3_BL_44JN[0];
                break;
            case TEMPERATURE_T:
                return &r_profile_temperature_BL_44JN[0];
                break;
            default:
                return NULL;
                break;
...
void dod_init(void)
{
    ...
    //<2014/07/02-tedwu, Fix power off mode charging 99% if replugging.
    battery_xlog_printk(BAT_LOG_CRTI, "~=>1:UI_SOC:%d\n\r", BMT_status.UI_SOC);
    //if ((g_rtc_fg_soc == 100)&&(gFG_capacity_by_v >= 95))
    //    BMT_status.UI_SOC = 100;
    //>2014/07/02-tedwu
    
    //<2014/06/29-tedwu, Fix MTK source code error.
...
//<2014/06/06-tedwu, For battery temperature protection.
    if (g_old_temperature != g_new_temperature)
    {
        cnt = (120/10); //120 seconds
        g_old_temperature = g_new_temperature;
    }
    
    if (cnt-- > 0)
    {
        g_spm_timer = 10;
        if (BMT_status.temperature > BMT_status.old_temperature)
            cnt = (120/10); //120 seconds
    }
    else if (BMT_status.temperature >= TEMP_POS_60_THRESHOLD)
        g_spm_timer = MAX_TEMPERATURE_WAKEUP_PERIOD;
    //else if (BMT_status.temperature > BMT_status.old_temperature)
    //    g_spm_timer = HIGH_TEMPERATURE_WAKEUP_PERIOD;
    else
    {
...
//    kal_int32 vbat_diff = 200;
    ...
    bat_spm_timeout_sync_ui_soc = true; //<2014/06/12-tedwu, Customize time and UI_SOC for SYNC_TO_REAL.//>
	battery_meter_ctrl(BATTERY_METER_CMD_GET_HW_OCV, &hw_ocv_after_sleep);
#if 0    
