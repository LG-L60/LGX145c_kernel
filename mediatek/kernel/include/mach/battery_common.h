...
typedef enum
{
	TEMP_POS_LOW = 0,
	TEMP_POS_NORMAL,
//<2014/04/09-Yuting Shih. Add the temperature level of battery check.
#if defined( ARIMA_LO1_HW ) || defined( ARIMA_LO2_HW )
	TEMP_POS_DEC_CHARGE,
	//TEMP_POS_PAUSE,  //<2014/05/25-tedwu, mask for Battery OTP modification. //>
#endif
