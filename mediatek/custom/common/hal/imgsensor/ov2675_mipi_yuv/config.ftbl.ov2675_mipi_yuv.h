...
FTABLE_SCENE_INDEP()
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        //<2014/04/16-kylechang, OVM7695 only support VGA and QVGA.
        SCENE_AS_DEFAULT_SCENE(
         ...
         //>2014/04/16-kylechang
    )
#endif
    //==========================================================================
#if 1
    //  Preview Size
//<20140722-kyle chang, [CTS Verifier 4.4_r3] Camera Formats
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
...
FTABLE_SCENE_DEP()
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
	    //<20140411-kyle chang, Select Fixed Focus only
