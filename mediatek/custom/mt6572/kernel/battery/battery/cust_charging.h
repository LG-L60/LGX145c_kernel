...
#define MAX_CHARGE_TEMPERATURE    55  //60  //<2014/05/18-tedwu //>
#define MAX_CHARGE_TEMPERATURE_MINUS_X_DEGREE	55
#define MAX_RECHARGE_TEMPERATURE  42    /* After STOP charge. */

#define MIN_CHARGE_TEMPERATURE    (-10)
#define MIN_CHARGE_TEMPERATURE_PLUS_X_DEGREE	(-5)
#define MIN_RECHARGE_TEMPERATURE  (-5)  /* After STOP charge. */
...
#define TEMP_CHECK_CHARGER_CURRENT    CHARGE_CURRENT_400_00_MA  //<2014/05/18-tedwu //>
#endif /* End.. (ARIMA_LO1_HW) */
//>2014/04/01-Yuting Shih.
...
#define SYNC_TO_REAL_TRACKING_TIME_FIRST	(10*60) // 10 min
#define SYNC_TO_REAL_UI_SOC_FIRST			98
#define SYNC_TO_REAL_TRACKING_TIME_SECOND	( 5*60) //  5 min
#define SYNC_TO_REAL_UI_SOC_SECOND			96
#define SYNC_TO_REAL_TRACKING_TIME_THIRD	( 3*60) //  3 min
#define SYNC_TO_REAL_UI_SOC_THIRD			94
...
//<2014/03/07-tedwu, [LO1] HIGH_BATTERY_VOLTAGE_SUPPORT for Battery (BL-44JH)(1700mAh).
...
//<2014/02/27-tedwu, Add Battery charging IC driver.
#ifdef MTK_BQ24158_SUPPORT
#define BQ24158_BUSNUM 1
#endif
//>2014/02/27-tedwu

//<2014/3/27-jhchen, LG battery OTP
#define LG_BATTERY_OTP
//>2014/3/27-jhchen
