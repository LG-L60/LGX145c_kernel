...
//#define FLASHLIGHT_CALI_LED_GAIN_PRV_TO_CAP_10X 10 //ORIG
#define FLASHLIGHT_CALI_LED_GAIN_PRV_TO_CAP_10X 80//<2014/04/14 Norman change from 40 to 80>
#define FLASHLIGHT_CALI_LED_GAIN_BURST_PRV_TO_CAP_10X 10
...
{
   //<2014/03/28-kyleChang. Add Preflash light & capture flash
   // return (MUINT32)FLASHLIGHT_CALI_LED_GAIN_PRV_TO_CAP_10X;  //ORIG
    return (MUINT32)FLASHLIGHT_CALI_LED_GAIN_BURST_PRV_TO_CAP_10X;
   //>2014/03/28-kyleChang
}
/*******************************************************************************
* Author : Jiale
...
*******************************************************************************/
//<2014/03/28-kyleChang. Add Preflash light & capture flash
#define FLASHLIGHT_YUV_MAIN_HI_LEVEL 48
//>2014/03/28-kyleChang
...
*******************************************************************************/
//<2014/5/2-37049-joubert.she, [Lo1/Lo2][DRV] update Lo1/Lo2 camera driver from norman.
#define FLASHLIGHT_YUV_MAIN_HI_TIMEOUT 750
//<2014/5/2-37049-joubert.she
